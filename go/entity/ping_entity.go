...
func NewPingEntity(client *core.FastconSDK, entopts map[string]any) *PingEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PingEntity) GetName() string { return e.name }
...
func (e *PingEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PingEntity) Deleted() bool {
	return e.deleted
}


func (e *PingEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPingEntity(e.client, opts)
}

func (e *PingEntity) Data(args ...any) any {
...
func (e *PingEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *PingEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PingEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *PingEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *PingEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PingCreateData and returns an Ping. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *PingEntity) CreateTyped(reqdata PingCreateData, ctrl map[string]any) (Ping, error) {
...
func (e *PingEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PingEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PingEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
