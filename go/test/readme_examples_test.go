...
const testSeed = `map[string]any{"entity": map[string]any{"ping": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "proxy": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
