# Fastcon SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FastconSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FastconSDK(...) and FastconSDK.test(...) become
#      FastconSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "fastcon_sdk"
_SDK_CLASS = "FastconSDK"
