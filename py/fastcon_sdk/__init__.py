...
from fastcon_sdk.utility import register

# Load features
from fastcon_sdk.feature.base_feature import FastconBaseFeature
from fastcon_sdk.features import _has_feature, _make_feature
...
class FastconSDK:
    ...
    def get_utility(self):
        return FastconUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("FastconSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Ping(self, data=None) -> "PingEntity":
        ...
        from fastcon_sdk.entity.ping_entity import PingEntity
        return PingEntity(self, data)


    def Proxy(self, data=None) -> "ProxyEntity":
        """Entity factory: client.Proxy().list() / client.Proxy().load({"id": ...})."""
        from fastcon_sdk.entity.proxy_entity import ProxyEntity
        return ProxyEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "FastconSDK":
        if sdkopts is None:
            sdkopts = {}
