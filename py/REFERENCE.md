# Fastcon Python SDK Reference

Complete API reference for the Fastcon Python SDK.
...
#### `FastconSDK.test(testopts=None, sdkopts=None)`
...
| --- | --- | --- | --- |
| `server_id` | `str` | No | The ID of the pinged server |
| `status` | `str` | No | Status of the ping operation |
...
| Field | Type | Required | Description |
| --- | --- | --- | --- |
| `id` | `str` | No | Unique identifier for the proxy server |
| `port` | `int` | Yes | Proxy server port number |
| `secret` | `str` | Yes | Secret key for proxy authentication |
| `server` | `str` | Yes | Proxy server hostname or IP address |
