...
func registerSDKWords(r *eng.Registry, client *sdk.FastconSDK) {
...
func runOp(client *sdk.FastconSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
