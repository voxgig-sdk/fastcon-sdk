...
Results: Successful ping response.
...
Results: Successful response with proxy list.
...
| --- | --- | --- | --- |
| Ping | `create` | `POST /api/ping` | See reference |
| Proxy | `list` | `GET /api/proxies` | See reference |

## Connect to the API

- Fastcon API Server: `https://fastcon.harknmav.fun`
...
- `fastcon_list`: List records for an entity. Supported entities: `proxy`.
- `fastcon_load`: Load one record for an entity. No active entity supports this operation.
