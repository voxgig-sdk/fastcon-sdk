...
|---|---|---|
| `ts/` | @voxgig-sdk/fastcon-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/fastcon-sdk \
      --repository voxgig-sdk/fastcon-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/fastcon-sdk` shows it, and
`npm trust revoke @voxgig-sdk/fastcon-sdk --id=<id>` removes it.
