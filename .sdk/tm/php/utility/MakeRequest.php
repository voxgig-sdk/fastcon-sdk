...
// Fastcon SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class FastconMakeRequest
{
    public static function call(FastconContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new FastconResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new FastconResponse($fetched);
        } else {
