...
// Fastcon SDK utility: fetcher

class FastconFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; FastconSDK/1.0)';
    ...
    public static function call(FastconContext $ctx, string $fullurl, array $fetchdef): array
    {
