...
class FastconStreamingFeature extends FastconBaseFeature
{
    ...
    private function _iterate(FastconResult $result): \Generator
    {
    ...
    private function _streamable(FastconContext $ctx): bool
    {
