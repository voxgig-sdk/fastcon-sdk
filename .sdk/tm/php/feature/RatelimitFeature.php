...
class FastconRatelimitFeature extends FastconBaseFeature
{
    ...
    private function _acquire(FastconContext $ctx): void
    {
    ...
    private function _track(FastconContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
