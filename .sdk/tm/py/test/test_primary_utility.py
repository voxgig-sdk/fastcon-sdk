...
from projectname_sdk import FastconSDK
from projectname_sdk.core.spec import FastconSpec
from projectname_sdk.core.result import FastconResult
from projectname_sdk.core.response import FastconResponse
from projectname_sdk.core.operation import FastconOperation
from projectname_sdk.core.error import FastconError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import FastconBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = FastconSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = FastconSDK.test(None, None)
        ...
        class TestInitFeature(FastconBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(FastconBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = FastconSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = FastconSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = FastconSDK.test(None, setup_opts)
