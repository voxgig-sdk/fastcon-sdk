...
from projectname_sdk.core.control import FastconControl
...
class FastconContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, FastconResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return FastconError(code, msg, self)
