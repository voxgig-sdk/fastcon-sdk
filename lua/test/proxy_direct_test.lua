...
describe("ProxyDirect", function()
  it("should direct-list-proxy", function()
    local setup = proxy_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-proxy", setup.live and "live" or "unit")
...
function proxy_direct_setup(mockres)
