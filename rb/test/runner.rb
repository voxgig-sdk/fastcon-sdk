...
module FastconTestRunner
  ...
  def self.env_override(m)
    live = getenv("FASTCON_TEST_LIVE")
    override = getenv("FASTCON_TEST_OVERRIDE")
    ...
    explain = getenv("FASTCON_TEST_EXPLAIN")
    m["FASTCON_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = FastconTestRunner
Helpers = FastconHelpers
Vs = VoxgigStruct
