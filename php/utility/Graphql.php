...
class FastconGraphql
{
    ...
    // equivalent.
    public static function body(FastconContext $ctx): mixed
    {
    ...
    public static function errors(FastconContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
