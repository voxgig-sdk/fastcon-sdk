...
// Fastcon SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FastconSDK::test)
...
{
    private const SDK_CLASS = 'FastconSDK';
    ...
    private const SDK_BASE = 'fastcon_sdk';
