...
class FastconTestRunner
{
    ...
    {
        $live = self::getenv('FASTCON_TEST_LIVE');
        $override = self::getenv('FASTCON_TEST_OVERRIDE');
        ...
        $explain = self::getenv('FASTCON_TEST_EXPLAIN');
...
class_alias('FastconTestRunner', 'Runner');
class_alias('FastconHelpers', 'Helpers');
