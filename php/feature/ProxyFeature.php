...
class FastconProxyFeature extends FastconBaseFeature
{
    ...
    public function init(FastconContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FastconContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
