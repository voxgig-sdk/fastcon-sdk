...
// Fastcon SDK clienttrack feature
...
class FastconClienttrackFeature extends FastconBaseFeature
{
    ...
    public function PostConstruct(FastconContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Fastcon-SDK';
