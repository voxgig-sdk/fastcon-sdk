...
class FastconCacheFeature extends FastconBaseFeature
{
    ...
    private function _through(FastconContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
