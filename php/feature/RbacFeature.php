...
class FastconRbacFeature extends FastconBaseFeature
{
    ...
    private function _required(FastconContext $ctx): ?string
    {
    ...
    private function _reject(FastconContext $ctx, string $required): void
    {
    ...
    private function _track(FastconContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
