...
class FastconTimeoutFeature extends FastconBaseFeature
{
    ...
    private function _with_timeout(FastconContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FastconContext $_ctx, float $ms): void
    {
        $client = $this->client;
