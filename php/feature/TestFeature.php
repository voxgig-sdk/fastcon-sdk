...
// Fastcon SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class FastconTestFeature extends FastconBaseFeature
{
    ...
    public function init(FastconContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (FastconContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (FastconContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(FastconContext $ctx, $op, $args): array
    {
