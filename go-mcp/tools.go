...
type Args struct {
	Entity string         `json:"entity" jsonschema:"ping | proxy"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.FastconSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "fastcon_list",
		Description: "List records from Fastcon. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "fastcon_load",
		Description: "Load a single record from Fastcon. " +
...
func runOp(client *sdk.FastconSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.FastconSDK, name string) (sdk.FastconEntity, error) {
	switch strings.ToLower(name) {
	case "ping":
		return client.Ping(nil), nil
	case "proxy":
		return client.Proxy(nil), nil
