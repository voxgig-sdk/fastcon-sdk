...
function envOverride(m) {
    if ('TRUE' === process.env.FASTCON_TEST_LIVE ||
        'TRUE' === process.env.FASTCON_TEST_OVERRIDE) {
    ...
    m.FASTCON_TEST_EXPLAIN = process.env.FASTCON_TEST_EXPLAIN || m.FASTCON_TEST_EXPLAIN;
    return m;
}
