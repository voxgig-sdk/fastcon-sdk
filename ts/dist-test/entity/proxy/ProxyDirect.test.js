...
(0, node_test_1.describe)('ProxyDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-proxy', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-proxy', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.FASTCON_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.FastconSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['FASTCON_TEST_PROXY_ENTID'];
    ...
    const client = new __1.FastconSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ProxyDirect.test.js.map