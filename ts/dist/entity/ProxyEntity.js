...
class ProxyEntity extends FastconEntityBase_1.FastconEntityBase {
    ...
    make() {
        return new ProxyEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<Proxy[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
